...
import 'auth.dart'; // import your AuthenticationPage
...
/// Painter for animated zigzag arrows
class _StockMarketArrowsPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    _drawAnimatedPath(canvas, greenPoints, greenPaint, greenProgress, arrowHeadSize);
    _drawAnimatedPath(canvas, redPoints, redPaint, redProgress, arrowHeadSize);
  }
